...
export declare function globedomRequest(this: IExecuteFunctions | ILoadOptionsFunctions, endpoint: string, qs: string, authsid: string | undefined, method: string): Promise<any>;
